...
const LinksAndDM = () => {
  ...
  // Load masterPin from localStorage on mount
  useEffect(() => {
  ...
  const handleForgotPin = () => {
    ...
    alert('🔄 PIN has been reset. You can set a new one on the preview page.');
  };

  const navigateToEditor = () => {
    if (!masterPin) {
      alert('⚠️ Please set a PIN first on the Preview page');
      ...
      <div className="bg-white rounded-3xl p-10 max-w-md w-full drop-shadow-2xl border-4 border-purple-300 text-center">
        ...
        {showForgotPin && (
          <div className="mt-4 p-4 bg-red-50 border-2 border-red-300 rounded-xl">
            <p className="text-sm text-gray-700 mb-3">Reset your PIN? This will clear your current PIN.</p>
            <button
      ...
      <div className="min-h-screen bg-gradient-to-b from-pink-400 via-orange-300 to-green-400 p-8" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-12">
            ...
            <button onClick={() => setCurrentView('preview')} className="bg-white text-purple-600 px-10 py-4 rounded-full font-bold text-xl hover:shadow-2xl transition transform hover:scale-110 drop-shadow-lg border-4 border-purple-200">Let's Do It!</button>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-3xl border-4 border-white p-10 max-w-2xl mx-auto text-center drop-shadow-2xl">
            ...
            <button onClick={() => setCurrentView('preview')} className="bg-white text-purple-600 px-12 py-5 rounded-3xl font-bold text-2xl hover:shadow-2xl transition transform hover:scale-110 drop-shadow-lg w-full mb-4 border-4 border-purple-200">Get Started Now</button>
    ...
    return (
      <div className="min-h-screen p-8" style={bgStyle}>
        ...
        <div className="max-w-md mx-auto">
          ...
          {/* PIN SETUP SECTION - ONLY ON PREVIEW */}
          <div className="mt-8 bg-white/30 rounded-3xl p-6 backdrop-blur border-4 border-white/50">
            <p className="text-white font-bold text-center mb-4">🔐 Security PIN Setup</p>
            
            {masterPin ? (
              <div className="text-center">
                <p className="text-white/90 text-sm mb-3">✅ PIN is set and saved</p>
                <button
                  onClick={() => setShowSetPin(!showSetPin)}
                  className="w-full bg-white/40 border-2 border-white text-white px-4 py-2 rounded-2xl font-bold text-sm hover:bg-white/60 transition"
                >
              ...
              <button
                onClick={() => setShowSetPin(!showSetPin)}
                className="w-full bg-white text-purple-600 px-4 py-2 rounded-2xl font-bold text-sm hover:shadow-lg transition"
              >
                Set PIN Now
              </button>
            )}
            ...
            {showSetPin && (
              <div className="mt-4 space-y-3">
                <input
                  ...
                  maxLength="10"
                  onKeyPress={(e) => {
                    if (e.key === 'Enter' && e.target.value) handleSetPin(e.target.value);
                  }}
                  className="w-full border-2 border-white/50 rounded-xl p-3 font-bold text-center bg-white/20 text-white placeholder-white/60"
                />
                <button
                  onClick={(e) => {
                    const input = e.target.parentElement.querySelector('input');
                    if (input.value) handleSetPin(input.value);
                  }}
                  className="w-full bg-white text-purple-600 px-4 py-2 rounded-xl font-bold hover:shadow-lg transition"
                >
                  Save PIN
                </button>
              </div>
          ...
          <div className="text-center mt-10 text-white/90">
            ...
            <button onClick={navigateToEditor} className="bg-white/40 backdrop-blur border-4 border-white text-white px-6 py-2 rounded-2xl font-bold text-base hover:bg-white/60 transition drop-shadow-lg mr-2">✏️ Editor</button>
            <button onClick={navigateToInbox} className="bg-white/40 backdrop-blur border-4 border-white text-white px-6 py-2 rounded-2xl font-bold text-base hover:bg-white/60 transition drop-shadow-lg">📬 Inbox ({messages.length})</button>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-14">
            ...
            <div className="flex justify-center gap-4">
              ...
              <button onClick={navigateToInbox} className="bg-white text-blue-600 px-8 py-3 rounded-2xl font-bold text-lg hover:shadow-xl transition transform hover:scale-110 drop-shadow-lg border-4 border-blue-200">📬 Inbox ({messages.length})</button>
            </div>
          </div>
